...
<body>
    <aside>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#{{ mod.name | replace('.', '-') }}">{{ mod.name }}</a></li>
                {% endfor %}
            </ul>
        </nav>
    </aside>
    <main>
        ...
        {% for mod in modules | sort(attribute='name') %}
        <section id="{{ mod.name | replace('.', '-') }}" class="doc-section">
            <h2>Module: {{ mod.name }}</h2>
            
            {% if mod.docstring %}
            <div class="module-doc">{{ mod.docstring | markdown | safe }}</div>
            {% endif %}
            ...
            <div class="item">
                ...
                {% if cls.docstring %}
                <div class="item-doc">{{ cls.docstring | markdown | safe }}</div>
                {% endif %}
                ...
                <div style="margin-left: 1.5rem; margin-top: 1rem; border-left: 2px solid var(--border); padding-left: 1rem;">
                    ...
                    {% if method.docstring %}
                    <div class="item-doc" style="font-size: 0.85rem;">{{ method.docstring | markdown | safe }}</div>
                    {% endif %}
                </div>
                {% endfor %}
            </div>
            ...
            <div class="item">
                ...
                {% if func.docstring %}
                <div class="item-doc">{{ func.docstring | markdown | safe }}</div>
                {% endif %}
            </div>
            {% endfor %}
            {% endif %}
            ...
            <div class="item">
                ...
                {% if var.docstring %}
                <div class="item-doc">{{ var.docstring | markdown | safe }}</div>
                {% endif %}
            </div>
            {% endfor %}
            {% endif %}
